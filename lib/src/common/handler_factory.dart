...
mixin CreateFinderFactory {
  ...
  Finder createFinder(SerializableFinder finder) {
    final Finder element = switch (finder.finderType) {
...
mixin CommandHandlerFactory {
  ...
  Future<Result> handleCommand(
    ...
    return switch (command.kind) {
      ...
      'get_element_count' => _getElementCount(command, finderFactory),
  ...
  Future<GetElementCountResult> _getElementCount(
    ...
    final getElementCountCommand = command as GetElementCount;
    final Finder target = await waitForElement(
      finderFactory.createFinder(getElementCountCommand.finder),
    );
    return GetElementCountResult(target.evaluate().length);
  }
